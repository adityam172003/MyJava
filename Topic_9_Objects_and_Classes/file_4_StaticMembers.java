...
// STATIC MEMBERS AND MEMBER FUNCTIONS NEVER GET INHERITED 
// WE CAN HIDE THEM BY DECLARING THE SAME SATIC METHOD - MEMBER IN PARENT CLASS CALLED METHOD HIDING 
	...
	public static void main(String[]args)
	{
		...
		*/
		...
		/*
			...
			the function call resoluting is done during compile time so 
			there is no runtime or dynamic binding concept for static members or methods 

			calls are depends on reference variable and not reference itself 
