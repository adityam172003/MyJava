/*
	...
	purpose of the abstract class 
		Acts as Base class 
	
		Abstract classes allow sharing code and maintaining state
		when you have incomplete information about the functions and their implementataion 
		and the implementation depends on the child class 

		share code for multiple classes 
